      ...
      <div className="containers">
        <div className="sign-in">
          <form onSubmit={handleSubmit}>
            ...
            <input type="text" name="prenom" placeholder="Family Name" value={formatData.prenom} onChange={handleInputChange} required />
            <label>Email</label>
            <input type="email" name="email" placeholder="E@example.com" value={formatData.email} onChange={handleInputChange} required />
            <label>Adresse</label>
            <input type="text" name="adresse" placeholder="Enter your home adress" value={formatData.adresse} onChange={handleInputChange} required />
            <label>Phone Number</label>
            <input type="text" name="telephone" placeholder="Enter your phone number" value={formatData.telephone} onChange={handleInputChange} required />
